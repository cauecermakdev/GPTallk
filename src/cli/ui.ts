...
export const printIntro = () => {
	intro(color.bgCyan(color.white(" Whatsapp ChatGPT English Speaker Bot ")));
	note("A Whatsapp bot that uses OpenAI's ChatGPT and some others APIs to be your partner english talker");
	s.start("Starting");
};
